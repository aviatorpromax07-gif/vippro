...
def save_user(user_id):
    """ফায়ারবেসে ইউজার সেভ করা হচ্ছে"""
    try:
...
async def play_hack_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # পূর্বের সকল গেম বহাল রেখে শেষে Coin SIGNAL বাটনটি যুক্ত করা হয়েছে
    keyboard =[
...
async def game_selection_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    elif game_type == 'game_coin': # Coin SIGNAL হ্যান্ডলার যুক্ত করা হয়েছে
        logo_url = LOGO_COIN
